    ...
    *,
    ...
    command = [
        ...
        *config.benchmark.protocols,
        ...
        str(config.benchmark.worker_empty_poll_sleep_min_ms),
        "--worker-empty-poll-sleep-max-ms",
        str(config.benchmark.worker_empty_poll_sleep_max_ms),
        "--job-poll-wait-ms",
        str(config.benchmark.job_poll_wait_ms),
        "--scheduler-active-job-pool-capacity",
        str(config.benchmark.scheduler_active_job_pool_capacity),
        ...
        str(config.benchmark.scheduler_storage_poll_wait_ms),
        "--flat-percent",
